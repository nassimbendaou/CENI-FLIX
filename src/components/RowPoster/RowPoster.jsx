...
import FirBaseUtils, { addToLastSeen } from "../../firebase/firebaseUtils";
...
//	console.log("hereeeee k,d", user)
	...
	const handlePlayAction = event => {
			addToLastSeen({ ...item, isFavourite });
			event.stopPropagation();
		...
		>
			...
			<div className="Row__poster-info">
				<div className="Row__poster-info--iconswrp">
					{FirBaseUtils.auth().currentUser.id == undefined ? (
						<Link
